    ...
    <section className="w-full h-full flex justify-center items-center">
      <form onSubmit={handleSubmit} className='w-3/4 grid grid-cols-2 relative bg-slate-600 p-20 rounded-lg'>
        ...
        <input className='p-2 rounded-md m-2 '
          ...
          required
        />
        <select className='p-2 rounded-md m-2' value={empresa} onChange={(e) => setEmpresa(Number(e.target.value))}>
        ...
        <input className='p-2 rounded-md m-2'
          ...
          required
        />
        <select className='p-2 rounded-md m-2' value={proceso} onChange={(e) => setProceso(Number(e.target.value))}>
        ...
        <input className='p-2 rounded-md m-2'
          type="text"
          placeholder="Rol / Analista / Supervisor / Auxiliar ..."
          value={rol}
